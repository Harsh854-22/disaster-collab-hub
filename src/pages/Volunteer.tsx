...
import NGOPartnerships from '@/components/NGOPartnerships';
  ...
  return (
    <Layout>
      <div className="space-y-10 animate-fade-in">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Volunteer Program</h1>
        ...
        <Tabs defaultValue="register" className="w-full">
          <TabsList className="grid w-full md:w-auto grid-cols-2">
            ...
            <TabsTrigger value="partners">NGO Partnerships</TabsTrigger>
          </TabsList>
